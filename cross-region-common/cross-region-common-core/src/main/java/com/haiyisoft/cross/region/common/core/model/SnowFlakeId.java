...
// ==============================Fields===========================================
    /**
     * 开始时间，从2022-01-01 00:00:00的时间开始
     */
...
//    }
    ...
    /**
     * 构造函数，必须指定workerId，且唯一；数据中心Id dataCenterId要按照规律设置，workerId和dataCenterId的组合必须唯一
     *
     ...
     */
//    @Deprecated
//    private static synchronized Long nextLongId() {
...
//    }
     ...
     */
//    @Deprecated
//    private static synchronized String nextStringId() {
